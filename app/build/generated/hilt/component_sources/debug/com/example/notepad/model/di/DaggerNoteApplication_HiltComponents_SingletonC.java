...
import com.example.notepad.model.database.DBHandler;
import com.example.notepad.model.database.NoteDao;
import com.example.notepad.model.repository.NoteRepository;
import com.example.notepad.view.ui.MainActivity;
...
public final class DaggerNoteApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends NoteApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_notepad_viewmodel_NoteViewModel, NoteViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_notepad_viewmodel_NoteViewModel = "com.example.notepad.viewmodel.NoteViewModel";

      @KeepFieldType
      NoteViewModel com_example_notepad_viewmodel_NoteViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends NoteApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_notepad_viewmodel_NoteViewModel, ((Provider) noteViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.notepad.viewmodel.NoteViewModel 
  ...
  private static final class SingletonCImpl extends NoteApplication_HiltComponents.SingletonC {
    ...
    private Provider<DBHandler> provideDatabaseProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<DBHandler>(singletonCImpl, 2));
      this.provideNoteDaoProvider = DoubleCheck.provider(new SwitchingProvider<NoteDao>(singletonCImpl, 1));
      this.provideNoteRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<NoteRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.notepad.model.repository.NoteRepository 
          return (T) AppModule_ProvideNoteRepositoryFactory.provideNoteRepository(singletonCImpl.provideNoteDaoProvider.get());

          case 1: // com.example.notepad.model.database.NoteDao 
          return (T) AppModule_ProvideNoteDaoFactory.provideNoteDao(singletonCImpl.provideDatabaseProvider.get());

          case 2: // com.example.notepad.model.database.DBHandler 
