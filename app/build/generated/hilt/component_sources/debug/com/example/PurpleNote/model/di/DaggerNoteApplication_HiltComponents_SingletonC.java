...
import com.example.PurpleNote.view.ui.MainActivity;
...
public final class DaggerNoteApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends NoteApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_PurpleNote_viewmodel_NoteViewModel, NoteViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_PurpleNote_viewmodel_NoteViewModel = "com.example.PurpleNote.viewmodel.NoteViewModel";

      @KeepFieldType
      NoteViewModel com_example_PurpleNote_viewmodel_NoteViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends NoteApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_PurpleNote_viewmodel_NoteViewModel, ((Provider) noteViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.PurpleNote.viewmodel.NoteViewModel 
