...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__upsertionAdapterOfNoteEntity = new EntityUpsertionAdapter<NoteEntity>(new EntityInsertionAdapter<NoteEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "INSERT INTO `NoteTable` (`id`,`title`,`description`,`date`,`image`,`voice`,`category`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE `NoteTable` SET `id` = ?,`title` = ?,`description` = ?,`date` = ?,`image` = ?,`voice` = ?,`category` = ? WHERE `id` = ?";
      }
      ...
      public List<NoteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new NoteEntity(_tmpId,_tmpTitle,_tmpDescription,_tmpDate,_tmpImage,_tmpVoice,_tmpCategory);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public NoteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new NoteEntity(_tmpId,_tmpTitle,_tmpDescription,_tmpDate,_tmpImage,_tmpVoice,_tmpCategory);
          } else {
            _result = null;
          }
          return _result;
