...
public class NoteViewModel extends androidx.lifecycle.ViewModel {
    ...
    @org.jetbrains.annotations.NotNull
    private final androidx.compose.runtime.MutableState<com.example.notepad.model.database.NoteEntity> _note = null;
    
    @javax.inject.Inject
    public NoteViewModel(@org.jetbrains.annotations.NotNull
    com.example.notepad.model.repository.NoteRepository repository) {
        super();
    }
    
    @org.jetbrains.annotations.NotNull
    public final androidx.lifecycle.LiveData<java.util.List<com.example.notepad.model.database.NoteEntity>> getAllNotes() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull
    public final androidx.lifecycle.LiveData<java.util.List<com.example.notepad.model.database.NoteEntity>> getSearchResults() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull
    public final androidx.compose.runtime.State<com.example.notepad.model.database.NoteEntity> getNote() {
        return null;
    }
    ...
    com.example.notepad.model.database.NoteEntity note) {
    }
}